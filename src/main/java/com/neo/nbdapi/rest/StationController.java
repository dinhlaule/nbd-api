...
import com.neo.nbdapi.rest.vm.SelectTypeVM;
...
public class StationController {
    ...
    @PostMapping("/station-object-type-select")
    public List<ComboBoxStr> getStationTypeComboBox(@RequestBody SelectTypeVM selectVM) throws SQLException {
        return stationService.getStationObjectTypeComboBox(selectVM.getTerm(), selectVM.getTypeId());
    }
